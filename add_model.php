...
session_start();  
   ...
   if(isset($_POST['addBtn'])){
      ...
      $q = $conn->prepare("INSERT INTO models (brandid, model) VALUES (:brandid, :model)");
...
<form action="add_model.php" method="POST">
    <p> 
        ...
        <input type="text" name="model" id="model" size="40" /><br />
        <input type="submit" value="add model" name="addBtn" />
    </p>
</form>
